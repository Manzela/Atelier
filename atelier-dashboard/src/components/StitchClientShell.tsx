  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="flex h-screen w-screen overflow-hidden bg-[var(--g-bg)] text-[var(--g-text)] stitch-grid-bg">
        ...
        >
          <div className="h-16 flex items-center px-6 border-b border-[var(--g-outline)]">
            <span className="font-medium text-[16px] tracking-wide text-white flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 relative">
            <div className="flex flex-col gap-6">
              <div className="flex bg-[var(--g-surface)] rounded-full p-1 border border-[var(--g-outline)]">
                <button className="flex-1 text-sm py-1.5 px-3 rounded-full bg-[var(--g-outline)] text-white font-medium shadow-sm cursor-default">
                  My projects
                </button>
              </div>
                ...
                <div className="flex flex-col gap-0.5">
                  {projects.map((proj) => (
                    <button
                      ...
                      className="text-left text-sm py-2 px-3 rounded-md hover:bg-[var(--g-surface-hover)] text-gray-300 truncate transition-colors w-full block"
                      title={proj.brief}
                    >
          ...
          {isMobileSidebarOpen && (
            <div className="fixed inset-0 z-40 md:hidden flex">
              ...
              >
                ...
                {/* Projects list */}
                <div className="flex bg-[var(--g-surface)] rounded-full p-1 border border-[var(--g-outline)] mb-4">
                  <button className="flex-1 text-xs py-1.5 px-3 rounded-full bg-[var(--g-outline)] text-white font-medium shadow-sm cursor-default">
                    My projects
                  </button>
                </div>
