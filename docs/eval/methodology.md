...
2. **Calibration golden set** — frozen task-by-task; correlation drop > 5% week-over-week triggers alert (publicly visible at TBD)
...
- [TBD](TBD) — public scoreboard
- [TBD](TBD) — public drift dashboard
