...
| 16  | **axis_weights YAML as Phase-1 planning artifact (deferral)**                                    | `surface_types` YAML and `visual_register` Python serve different design dimensions. Both retained: YAML for Phase-2 ConsensusAgent, Python for Phase-1 runtime. Reconciliation tracked as F0221.                                                                                                                    | [0016](docs/decisions/0016-axis-weights-yaml-as-planning-artifact.md) |
