# 0009. Public calibration dashboard at calibration.atelier.autonomous-agent.dev
...
We will publish judge calibration drift externally at **`calibration.atelier.autonomous-agent.dev`** as a continuously-updated public dashboard. Per Anthropic's published guidance, defended by:
...
- A small Cloud Function pushes the latest results to Firebase Hosting at `calibration.atelier.autonomous-agent.dev`
...
- `calibration.atelier.autonomous-agent.dev` — public dashboard URL
